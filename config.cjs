...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Imalka-MD&bGSzkQUQ",
  ...
  AUTO_RECORDING: process.env.AUTO_RECORDING !== undefined ? process.env.AUTO_RECORDING === 'ture' : false,
  ...
  OWNER_NAME: process.env.OWNER_NAME || "THARU",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94721614380",
